(function() {
  ...
  _.uniq = function(array, isSorted, iterator) {
    ...
    _.each(copy, function(elem){
      if(_.indexOf(iteratorVals, iterator(elem)) === -1){
           iteratorVals.push(iterator(elem));  
           originalVals.push(elem); 
      }
     })
     return originalVals;
    }  
  ...
  return _.reduce(collection, function(wasFound, value){
   ...
   return Boolean(iterator(value))  && wasFound;
   }, true)
  ...
  iterator = iterator || _.identity;
  return _.reduce(collection, function(isFound, value){
   if(isFound){
     return true;
   }
   return Boolean(iterator(value))  || isFound;
   }, false)
  };
  ...
  var args2 = [];
  args2.push(arguments[2], arguments[3]);
  return setTimeout(function(){return func.apply(this, args2);}, wait);
  };
